...
class CombinatorialOptimizerStrategy(InnerOptimizerStrategy):
    ...
    def run(self) -> Chromosome:
        ...
        return self.optimizer.run(
            ...
            adaptive_refine_samples=getattr(gr, "adaptive_refine_samples", 80_000),
            adaptive_refine_rounds=getattr(gr, "adaptive_refine_rounds", 2),
            adaptive_refine_uniform_ratio=getattr(gr, "adaptive_refine_uniform_ratio", 0.10),
            adaptive_refine_weighted_ratio=getattr(gr, "adaptive_refine_weighted_ratio", 0.30),
            adaptive_refine_local_ratio=getattr(gr, "adaptive_refine_local_ratio", 0.60),
